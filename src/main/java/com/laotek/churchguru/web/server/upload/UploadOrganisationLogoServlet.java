...
@WebServlet(urlPatterns = { "*.uploadOrganisationLogo" })
public class UploadOrganisationLogoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.saveOrganisationLogo(clientSessionId, base64Data, filename, contentType);
		}
	    }
