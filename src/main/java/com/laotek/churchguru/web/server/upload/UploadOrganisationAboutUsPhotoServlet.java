...
@WebServlet(urlPatterns = { "*.uploadOrganisationAboutUsPic" })
public class UploadOrganisationAboutUsPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.ABOUT_US_PHOTO, clientSessionId, base64Data, filename, contentType);
		}
	    }
