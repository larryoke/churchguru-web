...
@WebServlet(urlPatterns = { "*.uploadOrganisationPastorDeskPhoto" })
public class UploadOrganisationPastorDeskPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.PASTORS_DESK_PHOTO, clientSessionId, base64Data, filename,
			    contentType);
		}
	    }
