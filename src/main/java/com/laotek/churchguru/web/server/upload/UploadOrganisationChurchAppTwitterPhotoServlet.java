...
@WebServlet(urlPatterns = { "*.uploadOrganisationChurchAppTwitterPic" })
public class UploadOrganisationChurchAppTwitterPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.TWITTER_PHOTO, clientSessionId, base64Data, filename, contentType);
		}
	    }
