...
@WebServlet(urlPatterns = { "*.uploadOrganisationChurchAppYoutubePic" })
public class UploadOrganisationChurchAppYoutubePhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.YOUTUBE, clientSessionId, base64Data, filename, contentType);
		    break;
		}
	    }
