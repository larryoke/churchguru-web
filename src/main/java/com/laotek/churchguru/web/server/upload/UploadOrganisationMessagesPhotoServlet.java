...
@WebServlet(urlPatterns = { "*.uploadOrganisationChurchAppMessagesPic" })
public class UploadOrganisationMessagesPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.MESSAGES_PHOTO, clientSessionId, base64Data, filename, contentType);
		}
	    }
