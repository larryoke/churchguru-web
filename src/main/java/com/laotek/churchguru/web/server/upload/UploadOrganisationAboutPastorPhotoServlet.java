...
@WebServlet(urlPatterns = { "*.uploadOrganisationAboutPastorPic" })
public class UploadOrganisationAboutPastorPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.ABOUT_PASTOR_PHOTO, clientSessionId, base64Data, filename,
			    contentType);
		}
	    }
