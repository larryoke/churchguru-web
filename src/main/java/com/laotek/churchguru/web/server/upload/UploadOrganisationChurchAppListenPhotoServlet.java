...
@WebServlet(urlPatterns = { "*.uploadOrganisationChurchAppListenPic" })
public class UploadOrganisationChurchAppListenPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.LISTEN, clientSessionId, base64Data, filename, contentType);
		}
	    }
