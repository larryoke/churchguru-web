...
@WebServlet(urlPatterns = { "*.uploadOrganisationChurchAppWebsitePic" })
public class UploadOrganisationChurchAppWebsitePhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.WEBSITE, clientSessionId, base64Data, filename, contentType);
		    break;
		}
	    }
