...
@WebServlet(urlPatterns = { "*.uploadOrganisationDonatePic" })
public class UploadOrganisationDonatePhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.GIVE_PHOTO, clientSessionId, base64Data, filename, contentType);
		}
	    }
