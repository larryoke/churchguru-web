...
@WebServlet(urlPatterns = { "*.emailnewsletterupload" })
public class EmailNewsLetterUploadServlet extends UploadAction {
	...
	try {
	    ...
	    long id = photoDao.saveGalleryItem(base64Data, fileItem.getFieldName(), fileItem.getContentType());
	    return request.getContextPath() + "/uploadedphotos/photos/" + id + "/newsletter/";
