...
@WebServlet(urlPatterns = { "*.uploadOrganisationChurchAppWatchPic" })
public class UploadOrganisationChurchAppWatchPhotoServlet extends BasePhotoServlet {
	...
	try {
		...
		if ("discoSessionId".equals(cookie.getName())) {
		    ...
		    photoDao.savePhoto(LogoItemType.WATCH, clientSessionId, base64Data, filename, contentType);
		    break;
		}
	    }
