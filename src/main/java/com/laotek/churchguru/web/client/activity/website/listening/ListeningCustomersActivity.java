...
public class ListeningCustomersActivity extends AbstractActivity implements ListeningCustomersView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private ListeningCustomersView view;

    public ListeningCustomersActivity(ListeningCustomersPlace place, ClientFactory clientFactory) {
