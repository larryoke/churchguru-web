...
public class EStoreNotificationsActivity extends AbstractActivity implements EStoreNotificationsView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreNotificationsView view;

    public EStoreNotificationsActivity(EStoreNotificationsPlace place, ClientFactory clientFactory) {
