...
public class SubmitAudioMessageAction extends AbstractDispatchAction
	implements Action<SubmitAudioMessageResult>, HasOrganisationViewRole {
    ...
    public SubmitAudioMessageAction() {
    }
