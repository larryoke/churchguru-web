...
public class MessageSearchContext {
	...
	private static MessageSearchContext messagesContext = new MessageSearchContext();
	
	private BrowseMessagesType currentMessagesType;
	private Map<Integer, List<String>> pages = new HashMap<Integer, List<String>>();
	private int totalCount = 0;
	private int currentPageIndex = 0;	
	private int currentRowIndex = 0;
	
	private MessageSearchContext(){		
	}
	...
	public static MessageSearchContext getInstance(){
	...
	public void initSearchResults(BrowseMessagesType messagesType, Map<Integer, List<String>> results, int totalCount) {
		this.currentMessagesType = messagesType;
		this.pages = results;
		this.totalCount = totalCount;
	}
	
	public BrowseMessagesType getCurrentMessagesType(){
		return currentMessagesType;
	}
	...
	public boolean hasPreviousRecord(){
		if (currentPageIndex > 0 || (currentPageIndex == 0 && currentRowIndex > 0)){
			return true;
		}
		return false;
	}
