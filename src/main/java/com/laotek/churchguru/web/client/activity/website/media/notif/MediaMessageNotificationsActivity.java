...
public class MediaMessageNotificationsActivity extends AbstractActivity implements MediaMessageNotificationsView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private MediaMessageNotificationsView view;

    public MediaMessageNotificationsActivity(MediaMessageNotificationsPlace place, ClientFactory clientFactory) {
	...
	view = clientFactory.getEStoreNotificationsView();
