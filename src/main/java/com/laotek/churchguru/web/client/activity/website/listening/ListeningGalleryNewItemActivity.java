...
public class ListeningGalleryNewItemActivity extends AbstractActivity implements ListeningGalleryNewView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private ListeningGalleryNewView view;

    public ListeningGalleryNewItemActivity(ListeningGalleryNewItemPlace place, ClientFactory clientFactory) {
