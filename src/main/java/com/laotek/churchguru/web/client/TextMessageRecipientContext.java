...
public class TextMessageRecipientContext {
	private static TextMessageRecipientContext textMessageRecipientContext = new TextMessageRecipientContext();
	...
	public static TextMessageRecipientContext getInstance(){
