...
public class AudioMessageMessagesViewImpl extends BaseViewImpl implements AudioMessageMessagesView {
    ...
    public AudioMessageMessagesViewImpl() {
    ...
    @Override
    public void init(List<AudioMessageMessageDto> dtos) {
	panelRows.clear();
	...
	for (final AudioMessageMessageDto dto : dtos) {
		...
		public void onClick(ClickEvent event) {
		    ApplicationContext.getInstance().getPlaceController()
			    .goTo(new AudioMessageMessageNewPlace(dto.getIdentifier()));
