...
public class ListeningCategoryNewActivity extends AbstractActivity implements ListeningCategoryNewView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private ListeningCategoryNewView view;

    public ListeningCategoryNewActivity(ListeningCategoryNewPlace place, ClientFactory clientFactory) {
