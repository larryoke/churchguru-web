...
public class ListeningGalleryActivity extends AbstractActivity implements ListeningGalleryView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private ListeningGalleryView view;

    public ListeningGalleryActivity(ListeningGalleryPlace place, ClientFactory clientFactory) {
