...
public class ListeningNotificationsActivity extends AbstractActivity implements ListeningNotificationsView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private ListeningNotificationsView view;

    public ListeningNotificationsActivity(ListeningNotificationsPlace place, ClientFactory clientFactory) {
