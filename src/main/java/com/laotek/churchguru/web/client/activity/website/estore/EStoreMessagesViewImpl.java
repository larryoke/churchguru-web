...
public class EStoreMessagesViewImpl extends BaseViewImpl implements
	EStoreMessagesView {
	...
	mainPanel.getFlexCellFormatter().setHorizontalAlignment(0, 0,
	...
	for (final EStoreMessageDto dto : dtos) {
		...
		public void onClick(ClickEvent event) {
		    ApplicationContext
			    .getInstance()
			    .getPlaceController()
			    .goTo(new EStoreMessageNewPlace(dto.getIdentifier()));
	    ...
	    if (dto.getSpeakerDto() != null
		    && dto.getSpeakerDto().getFullnameDto() != null) {
