...
public class EStoreCategoryNewActivity extends AbstractActivity implements EStoreCategoryNewView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreCategoryNewView view;

    public EStoreCategoryNewActivity(EStoreCategoryNewPlace place, ClientFactory clientFactory) {
