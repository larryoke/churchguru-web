...
public class AudioMessagesViewImpl extends BaseViewImpl implements AudioMessagesView {
	...
	for (final AudioMessageDto dto : dtos) {
		...
		public void onClick(ClickEvent event) {
		    ApplicationContext.getInstance().getPlaceController()
			    .goTo(new AudioMessageNewPlace(dto.getIdentifier()));
