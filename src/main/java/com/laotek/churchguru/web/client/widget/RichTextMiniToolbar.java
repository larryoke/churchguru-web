...
public class RichTextMiniToolbar extends Composite {
    /** Local CONSTANTS **/
    ...
    private static final String HTTP_STATIC_ICONS_GIF = "images/app/icons.gif";
    ...
    public RichTextMiniToolbar(RichTextArea richtext) {
