...
public class EStoreCustomerDetailsActivity extends AbstractActivity implements EStoreCustomerDetailsView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreCustomerDetailsView view;

    public EStoreCustomerDetailsActivity(EStoreCustomerDetailsPlace place, ClientFactory clientFactory) {
