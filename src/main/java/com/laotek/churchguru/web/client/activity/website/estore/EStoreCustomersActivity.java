...
public class EStoreCustomersActivity extends AbstractActivity implements EStoreCustomersView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreCustomersView view;

    public EStoreCustomersActivity(EStoreCustomersPlace place, ClientFactory clientFactory) {
