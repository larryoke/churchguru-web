...
public class SliderBar extends FocusPanel implements ResizableWidget,
    ...
    /**
     * The owner of the slider
     */
    private HasSlider hasSlider;
     ...
     */
    public SliderBar(HasSlider hasSlider, double minValue, double maxValue) {
	this(hasSlider, minValue, maxValue, null);
    }
	...
	this(hasSlider, minValue, maxValue, labelFormatter,
