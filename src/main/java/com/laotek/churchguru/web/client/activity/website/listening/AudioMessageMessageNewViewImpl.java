...
public class AudioMessageMessageNewViewImpl extends BaseViewImpl implements AudioMessageMessageNewView {
    ...
    public AudioMessageMessageNewViewImpl() {
    ...
    @Override
    public void initNewMessage(AudioMessageMessageDto dto, List<AudioMessageSpeakerDto> speakers,
	    List<AudioMessageCategoryDto> categories, List<AudioMessageMessagePictureDto> pictures,
	...
	AudioMessageMessagePictureDto pictureDto = dto.getPictureDto();
	for (AudioMessageMessagePictureDto picture : pictures) {
	    if (pictureDto != null) {
	...
	List<AudioMessageNotificationDto> messageNotifications = dto.getNotificationDtos();
	if (messageNotifications != null && messageNotifications.size() > 0) {
	    for (AudioMessageNotificationDto ndto : messageNotifications) {
