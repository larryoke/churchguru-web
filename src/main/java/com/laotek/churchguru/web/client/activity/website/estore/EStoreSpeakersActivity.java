...
public class EStoreSpeakersActivity extends AbstractActivity implements EStoreSpeakersView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreSpeakersView view;

    public EStoreSpeakersActivity(EStoreSpeakersPlace place, ClientFactory clientFactory) {
    ...
    private void getSpeakers(final EStoreSpeakersView eStoreSpeakersView) {
