...
public class EStoreGalleryActivity extends AbstractActivity implements EStoreGalleryView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreGalleryView view;

    public EStoreGalleryActivity(EStoreGalleryPlace place, ClientFactory clientFactory) {
