...
public class AudioMessageNotificationsActivity extends AbstractActivity implements AudioMessageNotificationsView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private AudioMessageNotificationsView view;

    public AudioMessageNotificationsActivity(AudioMessageNotificationsPlace place, ClientFactory clientFactory) {
