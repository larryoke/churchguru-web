...
public class AudioMessageCustomersActivity extends AbstractActivity implements AudioMessageCustomersView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private AudioMessageCustomersView view;

    public AudioMessageCustomersActivity(AudioMessageCustomersPlace place, ClientFactory clientFactory) {
