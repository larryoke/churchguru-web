...
public class AudioMessageGalleryActivity extends AbstractActivity implements AudioMessageGalleryView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private AudioMessageGalleryView view;

    public AudioMessageGalleryActivity(AudioMessageGalleryPlace place, ClientFactory clientFactory) {
