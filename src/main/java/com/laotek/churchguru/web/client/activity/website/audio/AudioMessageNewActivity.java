...
public class AudioMessageNewActivity extends AbstractActivity implements
	AudioMessageNewView.Presenter {

    private ClientFactory clientFactory;
    private AudioMessageNewView view;
    private AudioMessageNewPlace place;

    public AudioMessageNewActivity(AudioMessageNewPlace place,
