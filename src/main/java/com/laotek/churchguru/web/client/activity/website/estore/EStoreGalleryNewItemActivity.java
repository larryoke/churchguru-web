...
public class EStoreGalleryNewItemActivity extends AbstractActivity implements EStoreGalleryNewView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreGalleryNewView view;

    public EStoreGalleryNewItemActivity(EStoreGalleryNewItemPlace place, ClientFactory clientFactory) {
