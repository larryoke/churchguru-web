...
public class WatchingMessagesViewImpl extends BaseViewImpl implements WatchingMessagesView {
    ...
    public WatchingMessagesViewImpl() {
	...
	for (final WatchingMessageDto dto : dtos) {
		...
		public void onClick(ClickEvent event) {
		    ApplicationContext.getInstance().getPlaceController()
			    .goTo(new WatchingMessageNewPlace(dto.getIdentifier()));
