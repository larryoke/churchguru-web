...
public class EStoreSpeakerNewActivity extends AbstractActivity implements EStoreSpeakerNewView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private EStoreSpeakerNewView view;

    public EStoreSpeakerNewActivity(EStoreSpeakerNewPlace place, ClientFactory clientFactory) {
