...
public class AudioMessageCustomerDetailsActivity extends AbstractActivity
	implements AudioMessageCustomerDetailsView.Presenter {

    private ClientFactory clientFactory;
    private String name;
    private AudioMessageCustomerDetailsView view;

    public AudioMessageCustomerDetailsActivity(AudioMessageCustomerDetailsPlace place, ClientFactory clientFactory) {
