...
public class GuestSearchContext {
	
	private static GuestSearchContext searchContext = new GuestSearchContext();
	
	private GuestSearchType currentSearchType;
	private Map<Integer, List<String>> pages = new HashMap<Integer, List<String>>();
	private int totalCount = 0;
	private int currentPageIndex = 0;	
	private int currentRowIndex = 0;
	
	private GuestSearchContext(){		
	}
	...
	public static GuestSearchContext getInstance(){
	...
	public void initSearchResults(GuestSearchType searchType, Map<Integer, List<String>> results, int totalCount) {
		this.currentSearchType = searchType;
		this.pages = results;
		this.totalCount = totalCount;
	}
	
	public GuestSearchType getCurrentSearchType(){
