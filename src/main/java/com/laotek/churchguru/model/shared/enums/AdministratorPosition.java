...
public enum AdministratorPosition implements Serializable, IsSerializable {
    ...
    private AdministratorPosition(String desc) {
	this.desc = desc;
    }
    ...
    public static AdministratorPosition find(String desc) {
	for (AdministratorPosition group : AdministratorPosition.values()) {
